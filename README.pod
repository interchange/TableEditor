...
New functionalities and custumization can be achieved by adding plugins.

=head2 Adding plugin

All plugins are located in /Plugins/name_of_plugin dir. Inside they usualy have folowing stucture:
...
You can add new or redifine any page by adding custom route and redirect it to custum controller (or leave default) and custum template (or default). In js/app.js.
...
In api.pm routes can be overridden. This is usefull for data manipulation before saving, data validation, custom information or similar. 
